...
class Main extends PluginBase
{
    ...
    protected function onEnable(): void
    {
        ...
        if (@socket_bind($this->socket, "0.0.0.0", $port) && @socket_listen($this->socket)) {
            ...
            $this->getScheduler()->scheduleRepeatingTask(new class($this->socket, $this->appPassword) extends Task {
                public function __construct(private $s, private $password) {}
